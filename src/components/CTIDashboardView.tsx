  ...
  return (
    <div className="space-y-3 text-slate-900 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        {/* Left Half (6 cols): Frontline Campaign Operations Central (2-column card grid) */}
        <div className="lg:col-span-6 bg-slate-50 border border-slate-200 rounded-2xl p-3 shadow-xs space-y-3">
          {/* Filter Controls Bar */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-[720px] overflow-y-auto pr-0.5">
            {filteredCampaigns.map((camp) => (
              <div
                key={camp.id}
                className="bg-white hover:bg-slate-50 border border-slate-200 hover:border-red-500/60 rounded-xl p-2.5 transition-all shadow-2xs flex flex-col justify-between group cursor-pointer"
        ...
        {/* Right Half (6 cols): Stacked boxes (1. Geopolitical Attribution, 2. TTP Dominance, 3. Reduced Targeted Industry Exposure) */}
        <div className="lg:col-span-6 space-y-3">
          ...
          {/* 3. Targeted Industry Threat Exposure (Reduced Size Box) */}
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-3 shadow-xs space-y-2">
            <div className="flex items-center justify-between pb-2 border-b border-slate-200">
              <div>
                <h3 className="text-xs font-bold text-slate-900 flex items-center gap-1.5">
