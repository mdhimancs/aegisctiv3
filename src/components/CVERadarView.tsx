              ...
              {filteredCVEs.map((cve) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between text-[10px] font-mono text-slate-500 mt-1.5 pt-1.5 border-t border-slate-100">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 shadow-xs space-y-2.5">
                ...
                {currentCVE.cvssVector && (
                  <div className="text-[10px] font-mono bg-slate-100 p-1.5 rounded-lg border border-slate-200 text-indigo-950">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3.5 shadow-xs space-y-3 font-mono">
                <div>
                  <h4 className="text-[10px] font-bold text-slate-700 uppercase tracking-wider mb-1">
                    Vulnerability Technical Assessment
                  </h4>
                  <pre className="text-[11px] text-indigo-950 leading-relaxed bg-slate-100 p-2.5 rounded-lg border border-slate-200 font-mono whitespace-pre-wrap break-all">
                    {currentCVE.summary}
                  </pre>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      {currentCVE.affectedProducts.map((prod, idx) => (
                        <div
                          key={idx}
                          className="bg-slate-100 p-1.5 rounded-lg border border-slate-200 text-[10px] text-indigo-950 font-mono"
                        >
                          {prod}
                        </div>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {currentCVE.threatActorsUsing.map((act, idx) => (
                        <span
                          key={idx}
                          className="px-2 py-0.5 rounded-md bg-red-50 border border-red-200 text-[10px] font-bold text-red-700 font-mono"
                        >
                          {act}
                        </span>
                      ))}
                ...
                <div className="pt-2.5 border-t border-slate-200">
                  ...
                  <pre className="bg-slate-100 border border-slate-200 p-2.5 rounded-lg text-[11px] text-indigo-950 whitespace-pre-wrap leading-relaxed font-mono">
