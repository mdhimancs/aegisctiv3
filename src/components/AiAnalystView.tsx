              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono">
                ...
                {analysisResult.recommendedYaraRule && (
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 shadow-xs space-y-2 flex flex-col justify-between">
                    ...
                    <pre className="bg-slate-100 p-3 rounded-xl border border-slate-300 text-xs font-mono text-purple-900 overflow-x-auto max-h-48">
                      {analysisResult.recommendedYaraRule}
                    </pre>
                  </div>
                )}
                ...
                {analysisResult.recommendedSigmaRule && (
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 shadow-xs space-y-2 flex flex-col justify-between">
                    ...
                    <pre className="bg-slate-100 p-3 rounded-xl border border-slate-300 text-xs font-mono text-emerald-800 overflow-x-auto max-h-48">
                      {analysisResult.recommendedSigmaRule}
                    </pre>
                  </div>
                )}
