    ...
    <div className="space-y-3 text-slate-900 font-sans">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 mt-0.5 font-mono">
              Real-time threat posture, active campaign tracking, and high-fidelity triage telemetry
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-2">
        ...
        <div className="lg:col-span-4 grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <div className="bg-white/80 backdrop-blur-md border border-slate-200 rounded-xl p-2.5 relative overflow-hidden shadow-xs group hover:border-red-500/50 transition-all">
            <div className="flex items-center justify-between text-slate-500 text-[9px] font-mono font-bold uppercase tracking-widest">
            ...
            <div className="mt-1 flex items-center justify-between">
              ...
              <span className="text-[8px] font-mono font-bold text-slate-400 bg-slate-100 px-1 rounded">94.2% CONFIDENCE</span>
            </div>
          </div>

          {/* Card 2: Active Alerts */}
          <div className="bg-white/80 backdrop-blur-md border border-slate-200 rounded-xl p-2.5 relative overflow-hidden shadow-xs group hover:border-amber-500/50 transition-all">
            <div className="flex items-center justify-between text-slate-500 text-[9px] font-mono font-bold uppercase tracking-widest">
        ...
        <div className="lg:col-span-4 bg-white/80 backdrop-blur-md border border-slate-200 rounded-xl p-2.5 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 text-[9px] font-mono font-bold uppercase tracking-widest mb-1">
            <span>Intel Sync & Control Plane</span>
            <CheckCircle2 className="w-2.5 h-2.5 text-emerald-600" />
          </div>
          
          <div className="grid grid-cols-3 gap-1.5 flex-1">
            <div className="flex flex-col items-center justify-center bg-slate-50/50 border border-slate-200/60 rounded-lg p-1.5 group hover:bg-white transition-colors">
          ...
          <div className="mt-1 pt-1 border-t border-slate-100 flex items-center justify-between text-[8px] font-mono text-slate-400">
        ...
        <div className="lg:col-span-4 grid grid-cols-1 sm:grid-cols-3 gap-2">
          {/* Card 3: Tracked IOCs */}
          <div className="bg-white/80 backdrop-blur-md border border-slate-200 rounded-xl p-2.5 relative overflow-hidden shadow-xs group hover:border-blue-500/50 transition-all">
            <div className="flex items-center justify-between text-slate-500 text-[9px] font-mono font-bold uppercase tracking-widest">
          ...
          <div className="bg-white/80 backdrop-blur-md border border-slate-200 rounded-xl p-2.5 relative overflow-hidden shadow-xs group hover:border-purple-500/50 transition-all">
            <div className="flex items-center justify-between text-slate-500 text-[9px] font-mono font-bold uppercase tracking-widest">
          ...
          <div className="bg-white/80 backdrop-blur-md border border-slate-200 rounded-xl p-2.5 relative overflow-hidden shadow-xs group hover:border-rose-500/50 transition-all">
            <div className="flex items-center justify-between text-slate-500 text-[9px] font-mono font-bold uppercase tracking-widest">
              <span>KEV Radar</span>
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-xl p-2 shadow-xs flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2 font-mono text-[10px] text-slate-600">
          ...
          <span>{sections.filter((s) => s.visible).length} of {sections.length} modules visible</span>
        </div>

        <div className="flex items-center gap-2 font-mono text-[10px]">
          <button
            onClick={() => setIsSectionsModalOpen(true)}
            className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 font-bold shadow-2xs transition-colors cursor-pointer"
          >
            <LayoutGrid className="w-3 h-3" />
            <span>Rearrange Modules</span>
          </button>
        </div>
      </div>
      ...
      {isPlainView ? (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-3 items-start">
          {/* Left Column: Graph (Half Width) & CVE Radar */}
          <div className="xl:col-span-6 space-y-3">
            {sections
              .filter((s) => s.visible && (s.id === 'velocity_chart' || s.id === 'cve_table'))
              .map((section) => {
                ...
                if (section.id === 'velocity_chart') {
                  return (
                    <div
                      key={section.id}
                      className="bg-white border border-slate-200/80 rounded-xl p-3.5 shadow-xs space-y-3"
                    >
                          ...
                          <div className="flex bg-slate-100 p-0.5 rounded-lg border border-slate-200">
                            {(['1h', '6h', '12h', '24h', '1mo'] as const).map((range) => (
                              <button
                                ...
                                className={`px-1.5 py-0.5 rounded-md text-[8px] font-bold font-mono transition-all cursor-pointer ${
                ...
                // Section 5: Weaponized CVEs / CISA KEV Radar on Left Side
                if (section.id === 'cve_table') {
                  return (
                    <div
                      key={section.id}
                      className="bg-white border border-slate-200/80 rounded-xl p-3.5 shadow-xs space-y-3 animate-in fade-in duration-300"
                    >
                      <div className="flex items-center justify-between pb-1.5 border-b border-slate-150">
                        <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        {(cves || []).slice(0, 4).map((cve) => (
                          <div
                            ...
                            className="bg-slate-50/70 hover:bg-slate-100/80 border border-slate-150 hover:border-rose-500/50 p-2.5 rounded-lg transition-all duration-200 cursor-pointer font-mono shadow-2xs flex flex-col justify-between"
                          >
                            <div>
                              <div className="flex items-center justify-between gap-1 mb-1">
                                <span className="text-[10px] font-bold text-blue-700">{cve.cveId}</span>
                                <span className="text-[9px] px-1.5 py-0.5 bg-rose-50 text-rose-700 border border-rose-200 font-bold rounded">
                                  {cve.cvssScore.toFixed(1)}
                                </span>
                              </div>
                            </div>
                            <div className="mt-1 pt-1 border-t border-slate-150 flex justify-between text-[9px] text-slate-500">
                              <span className="text-amber-700 font-bold">E: {(cve.epssScore * 100).toFixed(0)}%</span>
                              <span className="text-blue-600 font-bold opacity-0 group-hover:opacity-100 transition-opacity">Assess &rarr;</span>
                            </div>
                          </div>
                        ))}
                      </div>
          ...
          <div className="xl:col-span-6 space-y-3">
            {sections
              ...
              .map((section) => {
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                        {(campaigns || []).slice(0, 3).map((camp) => (
                          <div
                            key={camp.id}
                            onClick={() => onNavigateTab('cti')}
                            className="bg-slate-50/70 hover:bg-slate-100/80 border border-slate-150 hover:border-red-500/40 p-2.5 rounded-lg transition-all duration-200 cursor-pointer group shadow-2xs flex flex-col justify-between"
                          >
                            <div>
                              <div className="flex items-center justify-between gap-1 mb-1">
                            ...
                            <div className="flex items-center justify-between text-[10px] font-mono text-slate-500 mt-1 pt-1 border-t border-slate-150">
                              <span className="text-blue-600 font-bold">{camp.actorName}</span>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                        {(recentIOCs || []).slice(0, 4).map((ioc) => (
                          <div
                            ...
                            className="bg-slate-50/70 hover:bg-slate-100/80 border border-slate-150 hover:border-blue-500/40 p-2.5 rounded-lg transition-all duration-200 cursor-pointer font-mono shadow-2xs flex flex-col justify-between"
                          >
                            <div>
                              <div className="flex items-center justify-between gap-1 mb-1">
                            ...
                            <div className="mt-1 pt-1 border-t border-slate-150 flex justify-between text-[9px] text-slate-400">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                        {(actors || []).slice(0, 4).map((act) => (
                          <div
                            ...
                            className="bg-slate-50/70 hover:bg-slate-100/80 border border-slate-150 hover:border-amber-500/40 p-2.5 rounded-lg transition-all duration-200 cursor-pointer font-mono shadow-2xs flex flex-col justify-between"
                          >
                            <div>
                              <div className="flex items-center justify-between gap-1 mb-1">
                            ...
                            <div className="mt-1 pt-1 border-t border-slate-150 flex justify-between text-[9px] text-slate-600 font-bold">
                ...
                // Section 5: Weaponized CVEs (redundant fallback representation)
                if (section.id === 'cve_table') {
                  return (
                    <div
                      key={section.id}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                      {(cves || []).slice(0, 4).map((cve) => (
                        <div
                          key={cve.cveId}
                          onClick={() => onSelectCVE(cve)}
                          className="bg-slate-50 hover:bg-slate-50 border border-slate-200 hover:border-rose-500/50 p-2 rounded-lg transition-all cursor-pointer font-mono shadow-2xs flex flex-col justify-between"
                        >
                          <div>
                            <div className="flex items-center justify-between gap-1 mb-1">
              ...
              if (section.id === 'feeds_table') {
                return (
                  <div
                    key={section.id}
                    className="bg-white border border-slate-200/80 rounded-xl p-2.5 shadow-xs space-y-2 animate-in fade-in duration-300"
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                      {(feeds || []).slice(0, 4).map((feed) => (
                        <div
                          key={feed.id}
                          onClick={() => onNavigateTab('feeds')}
                          className="bg-slate-50/70 hover:bg-slate-100/80 border border-slate-150 hover:border-blue-500/40 p-2 rounded-lg transition-all duration-200 cursor-pointer font-mono shadow-2xs flex flex-col justify-between"
                        >
                          <div>
                            <div className="flex items-center justify-between gap-1 mb-1">
                          ...
                          <div className="mt-1.5 pt-1 border-t border-slate-150 flex justify-between items-center text-[9px]">
