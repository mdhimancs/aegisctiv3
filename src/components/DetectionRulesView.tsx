        ...
        {filteredRules.map((rule) => (
          ...
          >
            ...
            <div className="relative">
              <pre className="bg-slate-100 p-4 rounded-xl border border-slate-300 text-xs font-mono text-indigo-900 overflow-x-auto max-h-72 leading-relaxed selection:bg-purple-200">
                {rule.ruleContent}
              </pre>
            </div>
